               ...
               <div className="columns is-clearfix">
                  ...
                  <ul className="column is-pulled-left">
                     <li className="has-margin-bottom-10">
                        <label className="is-size-6 is-size-7-mobile" data-global="name">이름</label>. <span
                        data-global="name_value">임한솔</span>
                     </li>
                     <li className="has-margin-bottom-10">
                        <label className="is-size-6 is-size-7-mobile" data-global="birth">출생년도</label>. <span
                        data-global="birth_value">1996년 05월 20일</span>
                     </li>
                     <li className="has-margin-bottom-10">
                        <label className="is-size-6 is-size-7-mobile" data-global="email">이메일</label>. <a
                     ...
                     <li className="has-margin-bottom-10">
                        <label className="is-size-6 is-size-7-mobile" data-global="blog">Github</label>. <a
                        className="is-size-6 is-size-7-mobile"
                        href="https://github.com/hsol/"
                        target="_blank">@hsol</a>
                     </li>
                     <li className="has-margin-bottom-10">
                        <label className="is-size-6 is-size-7-mobile" data-global="blog">링크드인</label>. <a
                        className="is-size-6 is-size-7-mobile"
                        href="https://www.linkedin.com/in/devhansollim/"
                        target="_blank">@devhansollim</a>
                     </li>
                     <li>
                        <label className="is-size-6 is-size-7-mobile" data-global="blog">블로그</label>. <a
                        className="is-size-6 is-size-7-mobile"

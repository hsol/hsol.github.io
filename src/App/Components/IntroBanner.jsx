            ...
            <div className="hero-body">
               <div className="container z-index-1">
                  ...
                  <h2 className="subtitle is-size-3">
                     ...
                     <span className="tag is-light has-margin-right-5" data-aos="fade-up" data-aos-duration="500">#매_순간_스스로_발전하는_사람</span>
                     <span className="tag is-light has-margin-right-5" data-aos="fade-up" data-aos-duration="750">#언어_가리지_않는_유연한_개발자</span>
                     <span className="tag is-light has-margin-right-5" data-aos="fade-up" data-aos-duration="1000">#사용자를_먼저_생각하는_메이커</span>
                  </h2>
               </div>
            </div>
         </section>

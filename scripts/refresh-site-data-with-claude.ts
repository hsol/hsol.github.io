...
[확정 표기 - 매 회차 유지할 것(PRF-149, 본인 확정)]
- **헤더 전환어**: 헤더 한 줄은 "10년은 과거 개발자 경력이고 현직은 대표·팀장"으로 읽혀야 한다. 가운뎃점으로 과거 경력과 현직을 같은 층위에 늘어놓지 마라. 정본: "... · 개발자로 10년, 지금은 CEO @ 프루퍼 ㈜ · 플랫폼팀 팀장 @ ㈜ 피피비스튜디오스".
- **PPB-Studios 3단계**: "플랫폼팀 팀장 / 2025-06 - 현재" 한 줄로 눌러 쓰지 마라. 2025-06 부터 팀장이었던 것으로 읽힌다. 직책에 정식 발령 시점(2026-01)을 병기하고, 불릿에 "2025-06 파견 합류 - 2025-11 팀장 실무 시작 - 2026-01 정식 발령" 3단계를 남긴다.
- **팀 성과의 주어는 팀**: 플랫폼팀이 만든 성과를 1인칭 능동(내가 했다)으로 쓰지 않는다. 섹션·불릿 리드인으로 "팀장으로 이끈 팀 성과"임을 밝히고, 성과 귀속 표기는 "(PPB-Studios 플랫폼팀)" 처럼 팀을 주어로 둔다. 임한솔에게 귀속되는 것은 그 팀을 이끈 팀장 역할이다(vault "objects/people/임한솔.md" 귀속 규칙). 개발자 시기 개인 기여(RIDI 등)에는 이 리드인을 적용하지 않는다.
- **접은 제품은 과거형**: 프루퍼 인사이트·DevM 은 드롭됐다(vault "status: archived"). 운영 중으로 읽히는 현재형("기획·개발·운영", "operate")으로 쓰지 마라. 과거형("기획·개발·운영했고")으로 쓴다. 접었다고 따로 알릴 필요는 없다. Stream 은 진행 중이니 현재형을 유지한다.
`.trim();
